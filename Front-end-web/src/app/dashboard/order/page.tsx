        ...
        >
            ...
            >
                <div className="w-full flex flex-row justify-around items-center">
                    ...
                    >
                        <Input
                            prefix={<FiUserCheck className="text-gray-500" />}
                        />
                    </Form.Item>
                    <Form.Item
                        label="Số điện thoại"
                    ...
                    >
                        <Input
                            prefix={
                                <MdOutlineSettingsPhone className="text-gray-500" />
                            }
                        />
                    </Form.Item>
                </div>
                ...
                >
                    <Input
                        prefix={<FaRegAddressBook className="text-gray-500" />}
                    />
                </Form.Item>
                <div className="w-full flex flex-row justify-center items-center">
                    ...
                    >
                        <InputNumber
                            disabled
                            addonBefore={
                                <IoPricetagsOutline className="text-gray-600" />
                            }
                            formatter={(value) => {
                ...
                <div className="w-full flex flex-row justify-center items-center">
                    ...
                    >
                        <InputNumber
                            addonBefore={
                                <FaRegMoneyBill1 className="text-gray-500" />
                            }
                            width={"100%"}
                            min={0}
                            formatter={(value) => {
